...
void main(uint3 dispatchID : SV_DispatchThreadID)
{
    ...
    float2 uv = ProjectToUv(g_WorldToClip, worldPos);
    ...
    float3 diff = NRD_SanitizeRadiance(diffIrradiance / diffFactor);
    float3 spec = NRD_SanitizeRadiance(specIrradiance / specFactor);
