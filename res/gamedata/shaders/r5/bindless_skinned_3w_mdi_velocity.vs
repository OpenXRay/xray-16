...
VelocityVSOut main(VS_INPUT v)
{
    ...
    float4x4 bone = mdi_curr_bone(rec.boneOffset, id_0) * w0
                  + mdi_curr_bone(rec.boneOffset, id_1) * w1
                  + mdi_curr_bone(rec.boneOffset, id_2) * w2;
    float4x4 prevBone = mdi_prev_bone(rec, id_0) * w0
                      + mdi_prev_bone(rec, id_1) * w1
                      + mdi_prev_bone(rec, id_2) * w2;
