...
inline int xr_strcpy(char* destination, size_t const destination_size, const char* source)
{
    return strcpy_s(destination, destination_size, source);
}

inline int xr_strcat(char* destination, size_t const buffer_size, const char* source)
{
...
template <size_t count>
inline int xr_strcpy(char(&destination)[count], const char* source)
{
    return xr_strcpy(destination, count, source);
}

template <size_t count>
inline int xr_strcat(char(&destination)[count], const char* source)
{
