...
DLMALLOC_EXPORT mspace create_mspace(size_t capacity, int locked, out_of_memory_handler_type handler, out_of_memory_handler_parameter_type parameter);
...
*/
#ifdef USE_OUT_OF_MEMORY_HANDLER
DLMALLOC_EXPORT mspace create_mspace_with_base(void* base, size_t capacity, int locked, out_of_memory_handler_type handler, out_of_memory_handler_parameter_type parameter);
#else // #ifdef USE_OUT_OF_MEMORY_HANDLER
