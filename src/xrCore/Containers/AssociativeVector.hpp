...
public:
    ...
    IC insert_result emplace(key_type key, mapped_type value);
...
TEMPLATE_SPECIALIZATION
IC typename _associative_vector::insert_result _associative_vector::emplace(key_type key, mapped_type value) {
