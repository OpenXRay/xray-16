...
MTexture* MTextureCache::texture(MObject textureObj, MTexture::Type type /* = MTexture::RGBA */,
    bool mipmapped /* = true */, GLenum target /* = GL_TEXTURE_2D */)
{
    ...
    if (textureDirty || newTexture)
    {
        ...
        MPlug filenamePlug(textureObj, textureNode.attribute(MString("fileTextureName")));
...
bool MTextureCache::bind(MObject textureObj, MTexture::Type type /* = MTexture::RGBA */, bool mipmapped /* = true */,
