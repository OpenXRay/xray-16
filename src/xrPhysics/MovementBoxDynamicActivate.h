...
public:
    ...
    virtual void InterpolateBox(unsigned int id, float k) = 0;
};

XRPHYSICS_API bool ActivateBoxDynamic(IPHMovementControl* mov_control, bool character_exist, unsigned int id,
