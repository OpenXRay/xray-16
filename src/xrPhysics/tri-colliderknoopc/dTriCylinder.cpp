...
#define TEST(ax, nx, ox, c)                                                                                            \
    ...
    if (outV0 && outV1) TEST(0, 1, 2, 7)

    accurate_normalize(triSideAx1);
    if (outV1 && outV2) TEST(1, 2, 0, 8)

    accurate_normalize(triSideAx2);
    if (outV2 && outV0) TEST(2, 0, 1, 9)
#undef TEST
...
#define TEST(ax, nx, ox, c)                                                                                            \
    ...
    if (7 != code) TEST(0, 1, 2, 10)

    if (8 != code) TEST(1, 2, 0, 11)

    if (9 != code) TEST(2, 0, 1, 12)
...
#undef TEST
    ...
    else if (code < 7)  // 1-6
    {
        ...
        case 1:
            ...
            break;
        case 2:
            if (gl_state.test(fl_engaged_v2)) RETURN0;
    ...
    {  // 7-12
        ...
        if (gl_state.test(u8(flag & 0xff))) RETURN0;
