...
class CEdgeT : public CEdgeBase<_edge_weight_type, _vertex_type>
{
...
public:
    ...
    IC CEdgeT(const _edge_weight_type& weight, _vertex_type* vertex);
    IC bool operator==(const typename _vertex_type::vertex_id_type& vertex_id) const;
    IC bool operator==(const CEdgeT& obj) const;
    IC const _edge_data_type& data() const;
    IC _edge_data_type& data();
};

template <typename _edge_weight_type, typename _vertex_type>
class CEdgeT<_edge_weight_type, _vertex_type, Loki::EmptyType> : public CEdgeBase<_edge_weight_type, _vertex_type>
{
    using inherited = CEdgeBase<_edge_weight_type, _vertex_type>;
