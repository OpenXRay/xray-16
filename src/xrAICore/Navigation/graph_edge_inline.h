...
#define CSGraphEdge CEdgeT<_edge_weight_type, _vertex_type, _edge_data_type>

TEMPLATE_SPECIALIZATION
IC CSGraphEdge::CEdgeT(const _edge_weight_type& weight, _vertex_type* vertex) : inherited(weight, vertex) {}
TEMPLATE_SPECIALIZATION
...
TEMPLATE_SPECIALIZATION
IC bool CSGraphEdge::operator==(const CEdgeT& obj) const
{
...
#define CSGraphEdge CEdgeT<_edge_weight_type, _vertex_type, Loki::EmptyType>
