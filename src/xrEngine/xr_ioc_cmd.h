...
extern ENGINE_API int ps_r_rt_vol_light_samples;
...
extern ENGINE_API u32 ps_r_rt_quality;
...
extern ENGINE_API float ps_r_dlss_sharpness;
...
extern ENGINE_API int ps_r_ssr_debug;
