...
// if (object_is_crow_always)
    ...
    virtual const char* cNameSect_str() const = 0;
    ...
    // ~Properties
    virtual void Load(const char* section) = 0;
    virtual void PostLoad(const char* section) = 0; //--#SM+#--
    // Update
    ...
    virtual void reload(const char* section) = 0;
    // network
    ...
    virtual const char* visual_name(CSE_Abstract* entity) = 0;
    ...
    virtual const char* tip_text() = 0;
    virtual void set_tip_text(const char* text) = 0;
