...
ENGINE_API int ps_r_rt_sun_soft_samples = 4;
...
ENGINE_API int ps_r_fsr_fg = 0;
ENGINE_API float ps_r_fsr_sharpness = 0.2f;
...
ENGINE_API float ps_r_sky_ibl_intensity = 0.55f;
ENGINE_API int ps_r_ibl_prefilter = 1;
ENGINE_API int ps_r_ibl_probe_auto = 1;
ENGINE_API float ps_r_ibl_probe_radius = 10.f;
...
ENGINE_API int ps_r_sssss = 1;
ENGINE_API float ps_r_sssss_width = 1.35f;
ENGINE_API float ps_r_sssss_strength = 1.0f;
ENGINE_API int ps_r_sssss_debug = 0;
