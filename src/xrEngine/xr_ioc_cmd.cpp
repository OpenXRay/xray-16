...
ENGINE_API int ps_r_rt_gi_half = 0;
ENGINE_API float ps_r_rt_gi_intensity = 1.0f;
ENGINE_API int ps_r_rt_gi_spatial_samples = 3;
ENGINE_API float ps_r_rt_gi_spatial_radius = 40.0f;
ENGINE_API int ps_r_rt_gi_m_max = 8;
ENGINE_API int ps_r_rt_gi_local_samples = 16;
ENGINE_API int ps_r_rt_di_candidates = 12;
ENGINE_API int ps_r_rt_di_spatial_samples = 0;
ENGINE_API float ps_r_rt_di_spatial_radius = 32.0f;
ENGINE_API int ps_r_rt_di_m_max = 20;
ENGINE_API int ps_r_rt_gi_atrous_steps = 3;
ENGINE_API float ps_r_rt_gi_temporal_alpha = 0.96f;
ENGINE_API float ps_r_rt_gi_ambient_scale = 0.0f;
ENGINE_API int ps_r_rt_gi_bounces = 2;
ENGINE_API int ps_r_rt_gi_cache_size = 262144;
ENGINE_API float ps_r_rt_gi_cache_cell = 0.75f;
ENGINE_API int ps_r_rt_vol_steps = 16;
ENGINE_API int ps_r_rt_vol_light_samples = 2;
ENGINE_API float ps_r_rt_detail_dist = 20.f;
ENGINE_API float ps_r_rt_gi_lod_dist = 40.f;
ENGINE_API int ps_r_rt_sun_soft_samples = 2;
ENGINE_API float ps_r_rt_sun_angular = 0.0047f;
ENGINE_API u32 ps_r_rt_quality = 2;
ENGINE_API int ps_r_vol_fog = 0;
ENGINE_API float ps_r_vol_fog_density = 0.01f;
ENGINE_API float ps_r_vol_fog_height = 0.0f;
ENGINE_API float ps_r_vol_fog_falloff = 0.12f;
ENGINE_API float ps_r_vol_fog_g = 0.55f;
ENGINE_API float ps_r_vol_fog_noise = 0.65f;
ENGINE_API int ps_r_vol_fog_gi = 1;
ENGINE_API int ps_r_vol_fog_sun = 1;
ENGINE_API int ps_r_rt_refl = 1;
ENGINE_API int ps_r_vol_fog_rt = 1;
ENGINE_API int ps_r_vol_fog_lights = 4;
ENGINE_API int ps_r_vol_fog_temporal = 1;
ENGINE_API int ps_r_vol_fog_spot = 2;
ENGINE_API int ps_r_atmosphere = 1;
ENGINE_API float ps_r_atmosphere_strength = 0.22f;
ENGINE_API int ps_r_rt_pt_bounces = 4;
ENGINE_API int ps_r_rt_pt_ccap = 20;
ENGINE_API int ps_r_rt_pt_decorrelate = 1;
ENGINE_API int ps_r_taa = 1;
ENGINE_API float ps_r_taa_sharpness = 0.65f;
ENGINE_API int ps_r_taa_jitter = 1;
ENGINE_API float ps_r_render_scale = 1.0f;
ENGINE_API int ps_r_upscale = 0;
ENGINE_API int ps_r_upscale_quality = 3;
ENGINE_API int ps_r_dlss = 0;
ENGINE_API int ps_r_dlss_quality = 3;
ENGINE_API int ps_r_dlss_fg = 0;
ENGINE_API int ps_r_dlss_rr = 0;
ENGINE_API float ps_r_dlss_sharpness = 0.0f;
ENGINE_API int ps_r_dlss_auto_exposure = 1;
ENGINE_API int ps_r_denoise = 1;
ENGINE_API int ps_r_nrd_method = 0;
ENGINE_API int ps_r_nrd_apply = 1;
ENGINE_API int ps_r_hdr10 = 0;
ENGINE_API float ps_r_hdr10_hud = 200.f;
ENGINE_API float ps_r_hdr10_paper_white = 320.f;
ENGINE_API float ps_r_hdr10_peak = 1000.f;
ENGINE_API int ps_r_hdr_debug = 0;
ENGINE_API float ps_r_hdr_exposure_bias = 0.f;
ENGINE_API float ps_r_hdr_contrast = 1.f;
ENGINE_API float ps_r_hdr_saturation = 1.f;
ENGINE_API float ps_r_hdr_white = 1.7f;
ENGINE_API float ps_r_hdr_lift = 0.f;
ENGINE_API float ps_r_hdr_gamma = 1.f;
ENGINE_API float ps_r_hdr_gain = 1.f;
ENGINE_API float ps_r_hdr_temp = 0.f;
ENGINE_API float ps_r_hdr_tint = 0.f;
ENGINE_API float ps_r_hdr_bloom = 1.f;
