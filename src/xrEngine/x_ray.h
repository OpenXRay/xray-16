...
public:
    ...
    u32 Level_Current;
    void Level_Scan();
    int Level_ID(const char* name, const char* ver, bool bSet);
    void Level_Set(u32 ID);
    void LoadAllArchives();
    static CInifile* GetArchiveHeader(const char* name, const char* ver);

    // Loading
    void LoadBegin();
    void LoadEnd();
    void LoadTitleInt(const char* str1, const char* str2, const char* str3);
    void LoadStage();
    void LoadSwitch();
    void LoadDraw();
    void LoadForceDrop();
