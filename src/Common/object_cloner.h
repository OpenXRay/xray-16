...
struct CCloner
{
    ...
    IC static void clone(const char* _1, const char*& _2) { _2 = _1; }
    IC static void clone(char* _1, char*& _2) { _2 = xr_strdup(_1); }
...
IC void clone(const char* p0, char*& p1) { p1 = xr_strdup(p0); }
template <typename T>
