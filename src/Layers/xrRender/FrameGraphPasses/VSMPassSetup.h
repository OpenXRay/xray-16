...
constexpr u32 kVSMBucketAxis = 48;
constexpr u32 kVSMBucketMargin = 8;
constexpr u32 kVSMBucketsPerLevel = kVSMBucketAxis * kVSMBucketAxis;
constexpr u32 kVSMBucketItemCap[kVSMLevels] = { 1u << 18, 1u << 18, 1u << 18, 1u << 19, 1u << 19, 1u << 20 };
constexpr u32 kVSMBucketItemTotal = 3u * (1u << 18) + 2u * (1u << 19) + (1u << 20);
...
struct VSMState {
    ...
    nvrhi::BufferHandle bucketCount;
    nvrhi::BufferHandle bucketStart;
    nvrhi::BufferHandle bucketEnd;
    nvrhi::BufferHandle bucketCursor;
    nvrhi::BufferHandle bucketItems;
    bool bucketInit = false;
    bool bucketValid[kVSMLevels] = {};
    s32 bucketBase[kVSMLevels][2] = {};
    Fvector bucketSun[kVSMLevels];
    u32 bucketEntryCount = 0;
    float bucketErrK = -1.0f;
    u32 bucketRebuilds = 0;
    ...
    nvrhi::ComputePipelineHandle bucketCountPipeline;
    nvrhi::BindingLayoutHandle bucketCountLayout;
    nvrhi::ComputePipelineHandle bucketScanPipeline;
    nvrhi::BindingLayoutHandle bucketScanLayout;
    nvrhi::ComputePipelineHandle bucketFillPipeline;
    nvrhi::BindingLayoutHandle bucketFillLayout;
