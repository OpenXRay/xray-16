...
struct WetSurfacesPassState {
    ...
    u32 pipeVersion = 0;
    nvrhi::ITexture* waterRippleTex = nullptr;
    nvrhi::ITexture* waterFallTex = nullptr;
    nvrhi::ITexture* puddlesPerlinTex = nullptr;
    bool wetTexResolved = false;
};
...
struct WetSurfacesExtras
{
    ...
    nvrhi::ITexture* skyOpenTex = nullptr;
};
