...
bool g_fgEvaluatedLastFrame = false;
bool g_fgPresentedLastFrame = false;
...
bool EnsureFeature(nvrhi::ICommandList* cmd, const UpscaleInputs& inputs, bool wantRR)
{
    ...
    if (ps_r_dlss_auto_exposure || !inputs.exposure)
...
{
    g_fgPresentPending = false;
    g_fgEvaluatedLastFrame = false;
    g_fgPresentedLastFrame = false;
...
bool Streamline_FgEvaluatedLastFrame() { return false; }
bool Streamline_FgPresentedLastFrame() { return false; }
void Streamline_NotifyFgPresented(bool) {}
