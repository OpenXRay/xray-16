...
#   error No graphics API selected or enabled!
    ...
    if (!RImplementation.o.msaa)
        RImplementation.Target->u_setrtzb(RCache, RImplementation.Target->rt_Generic_0, RImplementation.Target->rt_Base_Depth);
    else
        RImplementation.Target->u_setrtzb(RCache, RImplementation.Target->rt_Generic_0_r, RImplementation.Target->rt_MSAADepth);
#endif // USE_OGL
    ...
    if (!RImplementation.o.msaa)
        RImplementation.Target->u_setrtzb(RCache, RImplementation.Target->rt_Generic_0, RImplementation.Target->rt_Generic_1, RImplementation.Target->rt_Base_Depth);
    else
        RImplementation.Target->u_setrtzb(RCache, RImplementation.Target->rt_Generic_0_r, RImplementation.Target->rt_Generic_1_r, RImplementation.Target->rt_MSAADepth);
#endif // USE_OGL
}
