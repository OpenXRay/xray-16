...
Flags32 ps_r__common_flags = { RFLAG_ACTOR_SHADOW | RFLAG_NO_RAM_TEXTURES | RFLAG_BULK_ANIM_LOAD }; // All renders
...
void xrRender_initconsole()
{
    ...
    CMD3(CCC_Mask, "r__bulk_anim_load", &ps_r__common_flags, RFLAG_BULK_ANIM_LOAD);
