...
public:
    ...
    virtual void __stdcall dbgDrawPlacement(
        const Fvector& p, int sz, u32 clr, const char* caption = 0, u32 clr_font = 0xffffffff);
    ...
    virtual void __stdcall dbgDrawFace(
        const Fvector& p0, const Fvector& p1, const Fvector& p2, u32 clr, const char* caption = 0);
    ...
    virtual void __stdcall OutText(
        const Fvector& pos, const char* text, u32 color = 0xFF000000, u32 shadow_color = 0xFF909090);
