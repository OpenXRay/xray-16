...
void CRenderTarget::phase_scene_prepare()
{
                                            ...
                                            ((ps_r_sun_shafts > 0) && (fValue >= 0.0001)) || (ps_r_ssao > 0)))
    {
        ...
        u_setrt(RCache, Device.dwWidth, Device.dwHeight, rt_Position->pRT, 0, 0, rt_MSAADepth->pZRT);
    ...
    {
        //	TODO: DX11: Check if we need to set RT here.
        u_setrt(RCache, Device.dwWidth, Device.dwHeight, get_base_rt(), 0, 0, rt_MSAADepth->pZRT);
        RCache.ClearZB(rt_MSAADepth, 1.0f, 0);
    }
