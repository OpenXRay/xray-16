...
namespace DX12
{
    ...
    private:
        ...
        void MakeDescriptorTable(u32 currentRangeCursor, u32& lastRangeCursor, u32 currentOffset, u32& lastOffset, D3D12_DESCRIPTOR_HEAP_TYPE eHeap, D3D12_SHADER_VISIBILITY eVisibility);
    };
    ...
    private:
        ...
        _smart_ptr<ID3D12RootSignature> m_pRootSignature;
        u32 m_nodeMask;
        THash m_Hash;
    };
    ...
    private:
        ...
        std::unordered_map<THash, _smart_ptr<RootSignature>> m_RootSignatureMap;
    };
}
