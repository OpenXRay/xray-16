...
namespace DX12
{
    ...
    void CommandListFence::WaitForFence(u64 fenceValue)
    {
    ...
    void CommandListFenceSet::WaitForFence(const u64 fenceValue, const int id) const
    {
    ...
    void CommandListFenceSet::WaitForFence(const u64 (&fenceValues)[CMDQUEUE_NUM]) const
    {
