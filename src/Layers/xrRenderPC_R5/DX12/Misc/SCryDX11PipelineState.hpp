...
template <typename T, EPipelineStatePropertyBits P>
struct SChangeTrackingValue<_smart_ptr<T>, P>
{
    UINT* m_pStateFlags;
    _smart_ptr<T> m_Value;
...
struct SCryDX11ShaderStageState
{
    ...
    SChangeTrackingValue<_smart_ptr<CCryDX12Shader>, EPSPB_PipelineState> Shader;
    SChangeTrackingArray<_smart_ptr<CCryDX12Buffer>, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT, EPSPB_ConstantBuffers> ConstantBufferViews;
    SChangeTrackingArray<_range_t<UINT>, D3D11_COMMONSHADER_CONSTANT_BUFFER_API_SLOT_COUNT, EPSPB_ConstantBuffers> ConstBufferBindRange;
    SChangeTrackingArray<_smart_ptr<CCryDX12ShaderResourceView>, D3D11_COMMONSHADER_INPUT_RESOURCE_SLOT_COUNT, EPSPB_Resources> ShaderResourceViews;
    SChangeTrackingArray<_smart_ptr<CCryDX12UnorderedAccessView>, D3D11_COMMONSHADER_INPUT_RESOURCE_SLOT_COUNT, EPSPB_Resources> UnorderedAccessViews;
    SChangeTrackingArray<_smart_ptr<CCryDX12SamplerState>, D3D11_COMMONSHADER_SAMPLER_SLOT_COUNT, EPSPB_Samplers> SamplerState;
...
struct SCryDX11IAState
{
    ...
    SChangeTrackingValue<_smart_ptr<CCryDX12InputLayout>, EPSPB_PipelineState> InputLayout;
    SChangeTrackingArray<_smart_ptr<CCryDX12Buffer>, D3D11_IA_VERTEX_INPUT_RESOURCE_SLOT_COUNT, EPSPB_VertexBuffers> VertexBuffers;
    ...
    SChangeTrackingValue<_smart_ptr<CCryDX12Buffer>, EPSPB_IndexBuffer> IndexBuffer;
...
{
    SChangeTrackingValue<_smart_ptr<CCryDX12DepthStencilState>, EPSPB_PipelineState> DepthStencilState;
    SChangeTrackingValue<_smart_ptr<CCryDX12RasterizerState>, EPSPB_PipelineState> RasterizerState;
...
{
    SChangeTrackingValue<_smart_ptr<CCryDX12BlendState>, EPSPB_PipelineState> BlendState;

    SChangeTrackingArray<_smart_ptr<CCryDX12RenderTargetView>, D3D11_SIMULTANEOUS_RENDER_TARGET_COUNT, EPSPB_RenderTargetViews> RenderTargetViews;
    ...
    SChangeTrackingValue<_smart_ptr<CCryDX12DepthStencilView>, EPSPB_DepthStencilView> DepthStencilView;
