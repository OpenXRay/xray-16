...
void CRenderTarget::build_textures()
{
    ...
    // Build noise table
    {
        ...
        u32 tempData[TEX_jitter_count - 1][TEX_jitter * TEX_jitter] = {0};

        {
            D3D_SUBRESOURCE_DATA subData[TEX_jitter_count - 1] = {NULL};
            ...
            ID3DTexture2D* t_noise_surf[TEX_jitter_count - 1] = {NULL};
