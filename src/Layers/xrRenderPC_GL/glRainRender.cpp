...
void glRainRender::Copy(IRainRender &_in)
{
	*this = *(glRainRender*)&_in;
}

#include "../../xrEngine/iGame_persistent.h"

void glRainRender::Render(CEffect_Rain &owner)
{
...
const Fsphere& glRainRender::GetDropBounds() const
{
