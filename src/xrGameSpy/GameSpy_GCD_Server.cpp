...
void CGameSpy_GCD_Server::ShutDown() { gcd_shutdown(); }
...
void CGameSpy_GCD_Server::DisconnectUser(int localid) { gcd_disconnect_user(GAMESPY_GAMEID, localid); };
void CGameSpy_GCD_Server::Think() { gcd_think(); };
char* CGameSpy_GCD_Server::GetKeyHash(int localid) { return gcd_getkeyhash(GAMESPY_GAMEID, localid); };
