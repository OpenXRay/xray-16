...
private:
    ...
    private:
        ...
        bool m_complete;
        static void login_result_cb(GPConnection* connection, void* arg, void* param);
    };
    ...
    void process_out_request(SAKESearchForRecordsInput* in, SAKESearchForRecordsOutput* out);
    bool process_record(SAKESearchForRecordsInput* in, SAKEField* fields, gamespy_profile::profile_data& dest_data,
