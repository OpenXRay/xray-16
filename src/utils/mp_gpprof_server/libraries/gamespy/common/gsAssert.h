...
/*
   ...
   assert.
     ...
     By having a custom critical error function, an asm "break" can be set in it, or a debugger break point.  a call
   stack is
     immediately available.  The error can be drawn onto the screen.  And the choice to ignore can also be given, in
   order
