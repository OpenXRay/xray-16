...
void ptw32_throw(DWORD exception)
{
    ...
    if (NULL == sp || sp->implicit) {
        ...
        switch (exception)
        {
        case PTW32_EPS_CANCEL: exitCode = (unsigned)PTHREAD_CANCELED; break;
        case PTW32_EPS_EXIT:
    ...
    switch (exception)
    {
    case PTW32_EPS_CANCEL: throw ptw32_exception_cancel(); break;
    case PTW32_EPS_EXIT: throw ptw32_exception_exit(); break;
    }
