...
fetch_profile_request::fetch_profile_request(request_ptr_t fcgx_request, user_name_t const profile_name)
    : m_fcg_request(fcgx_request), m_profile_name(profile_name), m_in(m_fcg_request->in), m_out(m_fcg_request->out),
