...
public:
    ...
    IC void ray_options(unsigned int f) { CL.ray_options(f); }
    ...
    IC void box_options(unsigned int f) { CL.box_options(f); }
    ...
    IC void frustum_options(unsigned int f) { CL.frustum_options(f); }
