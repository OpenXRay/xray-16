...
int lwGetTHeader(FILE* fp, int hsz, lwTexture* tex)
{
    ...
    while (1)
    {
        ...
        switch (id)
        {
        case ID_CHAN: tex->chan = getU4(fp); break;
        ...
        case ID_ENAB: tex->enabled = getU2(fp); break;

        case ID_NEGA: tex->negative = getU2(fp); break;

        case ID_AXIS: tex->axis = getU2(fp); break;
...
int lwGetTMap(FILE* fp, int tmapsz, lwTMap* tmap)
{
    ...
    while (1)
    {
        ...
        case ID_OREF: tmap->ref_object = getS0(fp); break;

        case ID_CSYS: tmap->coord_sys = getU2(fp); break;
...
int lwGetImageMap(FILE* fp, int rsz, lwTexture* tex)
{
    ...
    while (1)
    {
        ...
        case ID_VMAP: tex->param.imap.vmap_name = getS0(fp); break;

        case ID_AXIS: tex->param.imap.axis = getU2(fp); break;

        case ID_IMAG: tex->param.imap.cindex = getVX(fp); break;
        ...
        case ID_PIXB: tex->param.imap.pblend = getU2(fp); break;
...
int lwGetGradient(FILE* fp, int rsz, lwTexture* tex)
{
    ...
    while (1)
    {
        ...
        case ID_INAM: tex->param.grad.itemname = getS0(fp); break;

        case ID_GRST: tex->param.grad.start = getF4(fp); break;

        case ID_GREN: tex->param.grad.end = getF4(fp); break;

        case ID_GRPT: tex->param.grad.repeat = getU2(fp); break;
...
lwSurface* lwGetSurface(FILE* fp, int cksize)
{
    ...
    while (1)
    {
        ...
        case ID_RFOP: surf->reflection.options = getU2(fp); break;

        case ID_RIMG: surf->reflection.cindex = getVX(fp); break;
        ...
        case ID_TROP: surf->transparency.options = getU2(fp); break;

        case ID_TIMG: surf->transparency.cindex = getVX(fp); break;
        ...
        case ID_SIDE: surf->sideflags = getU2(fp); break;
        ...
        case ID_AVAL: surf->alpha = getF4(fp); break;
