...
//	if (strstr(path,"textures\\det\\"))				return true;
	...
	if (0 == xr_stricmp(p_name, "level")) return false;

	if (xr_stricmp(p_ext,".thm") &&
	...
	{
		if (0== xr_stricmp(p_ext,".aimap")	)	return true;
		if (0== xr_stricmp(p_ext,".cform")	)	return true;
		if (0== xr_stricmp(p_ext,".details"))	return true;
		if (0== xr_stricmp(p_ext,".prj")	)	return true;
		if (0== xr_stricmp(p_ext,".lights")	)	return false;
	}
	if (0== xr_stricmp(p_name,"do_light") && 0==xr_stricmp(p_ext,".ltx"))	return true;

	if (0==xr_stricmp(p_ext,".txt"))	return true;
	if (0==xr_stricmp(p_ext,".tga"))	return true;
	if (0==xr_stricmp(p_ext,".db"))	return true;
	if (0==xr_stricmp(p_ext,".smf"))	return true;

	if ('~'==p_ext[1])				return true;
	if ('_'==p_ext[1])				return true;
	if (0==xr_stricmp(p_ext,".vcproj"))	return true;
	if (0==xr_stricmp(p_ext,".sln"))	return true;
	if (0==xr_stricmp(p_ext,".old"))	return true;
	if (0==xr_stricmp(p_ext,".rc"))	return true;
