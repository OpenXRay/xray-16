...
HRESULT			__stdcall	xrIDirect3DVertexBuffer9::SetPrivateData	( REFGUID refguid,CONST void* pData,DWORD SizeOfData,DWORD Flags)	{APIDEBUG("xrIDirect3DVertexBuffer9::SetPrivateData");return S_OK;};
HRESULT			__stdcall	xrIDirect3DVertexBuffer9::GetPrivateData	( REFGUID refguid,void* pData,DWORD* pSizeOfData)					{APIDEBUG("xrIDirect3DVertexBuffer9::GetPrivateData");return S_OK;};
HRESULT			__stdcall	xrIDirect3DVertexBuffer9::FreePrivateData( REFGUID refguid)													{APIDEBUG("xrIDirect3DVertexBuffer9::FreePrivateData");return S_OK;};
DWORD			__stdcall	xrIDirect3DVertexBuffer9::SetPriority	( DWORD PriorityNew)												{APIDEBUG("xrIDirect3DVertexBuffer9::SetPriority");DWORD old = Priority; Priority = PriorityNew;  return old;};
DWORD			__stdcall	xrIDirect3DVertexBuffer9::GetPriority	()																	{APIDEBUG("xrIDirect3DVertexBuffer9::GetPriority");return Priority;};
void			__stdcall	xrIDirect3DVertexBuffer9::PreLoad		()																	{APIDEBUG("xrIDirect3DVertexBuffer9::PreLoad");};
...
HRESULT			__stdcall	xrIDirect3DVertexBuffer9::Unlock			()																	{APIDEBUG("xrIDirect3DVertexBuffer9::Unlock");return S_OK;};
HRESULT			__stdcall	xrIDirect3DVertexBuffer9::GetDesc		( D3DVERTEXBUFFER_DESC *pDesc)										{APIDEBUG("xrIDirect3DVertexBuffer9::GetDesc");return S_OK;};
