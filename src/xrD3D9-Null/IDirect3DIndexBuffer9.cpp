...
HRESULT			__stdcall	xrIDirect3DIndexBuffer9::SetPrivateData	( REFGUID refguid,CONST void* pData,DWORD SizeOfData,DWORD Flags)	{APIDEBUG("xrIDirect3DIndexBuffer9::SetPrivateData");return S_OK;};
HRESULT			__stdcall	xrIDirect3DIndexBuffer9::GetPrivateData	( REFGUID refguid,void* pData,DWORD* pSizeOfData)					{APIDEBUG("xrIDirect3DIndexBuffer9::GetPrivateData");return S_OK;};
HRESULT			__stdcall	xrIDirect3DIndexBuffer9::FreePrivateData( REFGUID refguid)													{APIDEBUG("xrIDirect3DIndexBuffer9::FreePrivateData");return S_OK;};
DWORD			__stdcall	xrIDirect3DIndexBuffer9::SetPriority	( DWORD PriorityNew)												{APIDEBUG("xrIDirect3DIndexBuffer9::SetPriority");DWORD old = Priority; Priority = PriorityNew;  return old;};
DWORD			__stdcall	xrIDirect3DIndexBuffer9::GetPriority	()																	{APIDEBUG("xrIDirect3DIndexBuffer9::GetPriority");return Priority;};
...
HRESULT			__stdcall	xrIDirect3DIndexBuffer9::Unlock			()																	{APIDEBUG("xrIDirect3DIndexBuffer9::Unlock");return S_OK;};
HRESULT			__stdcall	xrIDirect3DIndexBuffer9::GetDesc		( D3DINDEXBUFFER_DESC *pDesc)										{APIDEBUG("xrIDirect3DIndexBuffer9::GetDesc");return S_OK;};
