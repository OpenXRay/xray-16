...
HRESULT			xrIDirect3DSurface9::SetPrivateData	( REFGUID refguid,CONST void* pData,DWORD SizeOfData,DWORD Flags)	{APIDEBUG("xrIDirect3DSurface9::SetPrivateData");return S_OK;};
HRESULT			xrIDirect3DSurface9::GetPrivateData	( REFGUID refguid,void* pData,DWORD* pSizeOfData)					{APIDEBUG("xrIDirect3DSurface9::GetPrivateData");return S_OK;};
HRESULT			xrIDirect3DSurface9::FreePrivateData( REFGUID refguid) 													{APIDEBUG("xrIDirect3DSurface9::FreePrivateData");return S_OK;};
DWORD			xrIDirect3DSurface9::SetPriority	( DWORD PriorityNew) 												{APIDEBUG("xrIDirect3DSurface9::SetPriority"); DWORD old = Priority; Priority = PriorityNew;  return old;};
DWORD			xrIDirect3DSurface9::GetPriority	() 																	{APIDEBUG("xrIDirect3DSurface9::GetPriority");return Priority;};
...
HRESULT			xrIDirect3DSurface9::GetContainer	( REFIID riid,void** ppContainer) 									{APIDEBUG("xrIDirect3DSurface9::GetContainer");return S_OK;};
...
HRESULT			xrIDirect3DSurface9::GetDC			( HDC *phdc) 														{APIDEBUG("xrIDirect3DSurface9::GetDC");return S_OK;};
HRESULT			xrIDirect3DSurface9::ReleaseDC		( HDC hdc) 															{APIDEBUG("xrIDirect3DSurface9::ReleaseDC");return S_OK;};