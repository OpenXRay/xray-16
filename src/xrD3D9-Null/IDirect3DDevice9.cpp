...
{ APIDEBUG("xrIDirect3DDevice9::SetDialogBoxMode");  return S_OK; };
...
{ APIDEBUG("xrIDirect3DDevice9::CreateVolumeTexture");  return S_OK; };
...
{ APIDEBUG("xrIDirect3DDevice9::CreateRenderTarget");  return S_OK; };
...
{ APIDEBUG("xrIDirect3DDevice9::CreateDepthStencilSurface");  return S_OK; };
...
{ APIDEBUG("xrIDirect3DDevice9::StretchRect");  return S_OK; };
HRESULT		xrIDirect3DDevice9::ColorFill( IDirect3DSurface9* pSurface,CONST RECT* pRect,D3DCOLOR color) 
{ APIDEBUG("xrIDirect3DDevice9::ColorFill");  return S_OK; };
...
{ APIDEBUG("xrIDirect3DDevice9::SetNPatchMode");  return S_OK; };
float		xrIDirect3DDevice9::GetNPatchMode() 
{ APIDEBUG("xrIDirect3DDevice9::GetNPatchMode");  return 0.0f; };
HRESULT		xrIDirect3DDevice9::DrawPrimitive( D3DPRIMITIVETYPE PrimitiveType,UINT StartVertex,UINT PrimitiveCount) 
{ APIDEBUG("xrIDirect3DDevice9::DrawPrimitive");  return S_OK; };
...
{ APIDEBUG("xrIDirect3DDevice9::DrawIndexedPrimitive");  return S_OK; };
...
{ APIDEBUG("xrIDirect3DDevice9::DrawPrimitiveUP");  return S_OK; };
...
{ APIDEBUG("xrIDirect3DDevice9::DrawIndexedPrimitiveUP");  return S_OK; };
...
{ APIDEBUG("xrIDirect3DDevice9::ProcessVertices");  return S_OK; };
...
{ APIDEBUG("xrIDirect3DDevice9::SetVertexDeclaration");  return S_OK; };
HRESULT		xrIDirect3DDevice9::GetVertexDeclaration( IDirect3DVertexDeclaration9** ppDecl) 
{ APIDEBUG("xrIDirect3DDevice9::GetVertexDeclaration"); return S_OK; };
HRESULT		xrIDirect3DDevice9::SetFVF( DWORD FVF) 
{ APIDEBUG("xrIDirect3DDevice9::SetFVF");  return S_OK; };
HRESULT		xrIDirect3DDevice9::GetFVF( DWORD* pFVF) 
{ APIDEBUG("xrIDirect3DDevice9::GetFVF");  return S_OK; };
...
{ APIDEBUG("xrIDirect3DDevice9::SetStreamSource");  return S_OK; };
...
{ APIDEBUG("xrIDirect3DDevice9::SetPixelShader");  return S_OK; };
HRESULT		xrIDirect3DDevice9::GetPixelShader( IDirect3DPixelShader9** ppShader) 
{ APIDEBUG("xrIDirect3DDevice9::GetPixelShader");  return S_OK; };
HRESULT		xrIDirect3DDevice9::SetPixelShaderConstantF( UINT StartRegister,CONST float* pConstantData,UINT Vector4fCount) 
{ APIDEBUG("xrIDirect3DDevice9::SetPixelShaderConstantF");  return S_OK; };
HRESULT		xrIDirect3DDevice9::GetPixelShaderConstantF( UINT StartRegister,float* pConstantData,UINT Vector4fCount) 
{ APIDEBUG("xrIDirect3DDevice9::GetPixelShaderConstantF");  return S_OK; };
HRESULT		xrIDirect3DDevice9::SetPixelShaderConstantI( UINT StartRegister,CONST int* pConstantData,UINT Vector4iCount) 
{ APIDEBUG("xrIDirect3DDevice9::SetPixelShaderConstantI");  return S_OK; };
HRESULT		xrIDirect3DDevice9::GetPixelShaderConstantI	( UINT StartRegister,int* pConstantData,UINT Vector4iCount)						{ APIDEBUG("xrIDirect3DDevice9::GetPixelShaderConstantI");  return S_OK; };
HRESULT		xrIDirect3DDevice9::SetPixelShaderConstantB	( UINT StartRegister,CONST BOOL* pConstantData,UINT  BoolCount)					{ APIDEBUG("xrIDirect3DDevice9::SetPixelShaderConstantB");  return S_OK; };
HRESULT		xrIDirect3DDevice9::GetPixelShaderConstantB	( UINT StartRegister,BOOL* pConstantData,UINT BoolCount)						{ APIDEBUG("xrIDirect3DDevice9::GetPixelShaderConstantB");  return S_OK; };
HRESULT		xrIDirect3DDevice9::DrawRectPatch			( UINT Handle,CONST float* pNumSegs,CONST D3DRECTPATCH_INFO* pRectPatchInfo)	{ APIDEBUG("xrIDirect3DDevice9::DrawRectPatch");  return S_OK; };
HRESULT		xrIDirect3DDevice9::DrawTriPatch			( UINT Handle,CONST float* pNumSegs,CONST D3DTRIPATCH_INFO* pTriPatchInfo)		{ APIDEBUG("xrIDirect3DDevice9::DrawTriPatch");  return S_OK; };
HRESULT		xrIDirect3DDevice9::DeletePatch				( UINT Handle)																	{ APIDEBUG("xrIDirect3DDevice9::DeletePatch");  return S_OK; };
