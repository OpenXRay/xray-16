...
{
    PHelper().CreateCaption(items, "Quality", make_string("%3.2f", m_fQuality).c_str());
    PHelper().CreateCaption(items, "Min Dist", make_string("%3.2f", m_fMinDist).c_str());
    PHelper().CreateCaption(items, "Max Dist", make_string("%3.2f", m_fMaxDist).c_str());
    PHelper().CreateCaption(items, "Max AI Dist", make_string("%3.2f", m_fMaxAIDist).c_str());
    PHelper().CreateCaption(items, "Base Volume", make_string("%3.2f", m_fBaseVolume).c_str());
