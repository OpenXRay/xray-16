...
class TfraLeftBar : public TFrame
{
    ...
    void __fastcall ebCustomFileMouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
    void __fastcall tvEngineKeyDown(TObject* Sender, WORD& Key, TShiftState Shift);
    ...
    void __fastcall ExtBtn10MouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
