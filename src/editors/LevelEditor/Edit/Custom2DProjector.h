...
public:
    ...
    bool GetColor(u32 &color, int U, int V)
    {
    ...
    float GetUFromX(float x, const Fbox &box)
    {
        R_ASSERT(Valid());
    ...
    int GetPixelUFromX(float x, const Fbox &box)
    {
    ...
    float GetVFromZ(float z, const Fbox &box)
    {
        R_ASSERT(Valid());
    ...
    int GetPixelVFromZ(float z, const Fbox &box)
    {
