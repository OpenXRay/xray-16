...
#include "scene.h"
#include "editors/ECore/Editor/ExportSkeleton.h"
//.#include "clsid_game.h"
#include "editors/ECore/Editor/ui_main.h"
#include "UI_LevelTools.h"
#include "editors/ECore/Editor/GeometryCollector.h"
...
bool build_mesh(const Fmatrix &parent, CEditableMesh *mesh, CGeomPartExtractor *extractor, u32 game_mtl_mask, BOOL ignore_shader)
{
    bool bResult = true;
