...
void __fastcall TfrmOneColor::tvDOListDragDrop(TObject* Sender, TObject* Source, int X, int Y)
{
...
void __fastcall TfrmOneColor::tvDOListStartDrag(TObject* Sender, TDragObject*& DragObject)
{
