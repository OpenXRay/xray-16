...
class TfrmOneColor : public TForm
{
    ...
    TElTree* tvDOList;
    void __fastcall mcColorMouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
    void __fastcall FormClose(TObject* Sender, TCloseAction& Action);
    void __fastcall ebMultiRemoveClick(TObject* Sender);
    void __fastcall tvDOListDragOver(TObject* Sender, TObject* Source, int X, int Y, TDragState State, bool& Accept);
    void __fastcall tvDOListDragDrop(TObject* Sender, TObject* Source, int X, int Y);
