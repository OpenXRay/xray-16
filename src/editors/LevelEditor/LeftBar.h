...
class TfraLeftBar : public TFrame
{
    ...
    void __fastcall ebSceneMouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
    void __fastcall ExtBtn7MouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
    void __fastcall ExtBtn8MouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
    ...
    void __fastcall ExtBtn1MouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
    ...
    void __fastcall ebImagesMouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
    ...
    void __fastcall ebSoundsMouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
    void __fastcall ExtBtn2MouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
    void __fastcall MakeAIMap1Click(TObject* Sender);
    void __fastcall ebCompileMouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
