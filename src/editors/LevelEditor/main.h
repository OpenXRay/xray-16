    ...
    public TForm
{
    ...
    void __fastcall D3DWindowKeyDown(TObject* Sender, WORD& Key, TShiftState Shift);
    ...
    void __fastcall D3DWindowMouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
    void __fastcall D3DWindowMouseUp(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
    void __fastcall D3DWindowMouseMove(TObject* Sender, TShiftState Shift, int X, int Y);
