...
class TfrmEditLightAnim : public TForm
{
    ...
    void __fastcall pbGMouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
    void __fastcall sePointerKeyDown(TObject* Sender, WORD& Key, TShiftState Shift);
    ...
    void __fastcall pbGMouseMove(TObject* Sender, TShiftState Shift, int X, int Y);
    void __fastcall pbGMouseUp(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
