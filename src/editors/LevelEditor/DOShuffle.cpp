...
{
    m_ObjectProps = TProperties::CreateForm("Objects", paObjectProps, alClient,
        fastdelegate::bind<TOnChooseClose>(this, &TfrmDOShuffle::OnObjectPropsModified));
...
// implementation
//---------------------------------------------------------------------------
__fastcall TfrmDOShuffle::TfrmDOShuffle(TComponent* Owner, EDetailManager* dm_tools) : TForm(Owner)
{
...
//---------------------------------------------------------------------------
void __fastcall TfrmDOShuffle::FormKeyDown(TObject* Sender, WORD& Key, TShiftState Shift)
{
...
void __fastcall TfrmDOShuffle::tvMultiDragOver(
...
void __fastcall TfrmDOShuffle::tvMultiStartDrag(TObject* Sender, TDragObject*& DragObject)
{
...
void __fastcall TfrmDOShuffle::tvItemsDragOver(
    TObject* Sender, TObject* Source, int X, int Y, TDragState State, bool& Accept)
{
    Accept = false;
    if (Source == tvItems)
...
void __fastcall TfrmDOShuffle::tvItemsStartDrag(TObject* Sender, TDragObject*& DragObject)
{
