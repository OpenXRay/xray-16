...
class TfraLeftBar : public TFrame
{
    ...
    void __fastcall ebImageCommandsMouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
    ...
    void __fastcall ebFileMouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
    void __fastcall ebCreateMouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
    void __fastcall fsStorageRestorePlacement(TObject* Sender);
    void __fastcall fsStorageSavePlacement(TObject* Sender);
    void __fastcall ebPGCreateClick(TObject* Sender);
    void __fastcall ebEngineRemoveClick(TObject* Sender);
    void __fastcall ebSoundCommandsMouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
