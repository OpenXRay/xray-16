...
public:
    ...
    IC
        ...
        void
        SetRect(int l, int t, int w, int h, u32 rect_clr, u32 back_clr)
    {
        lt.set(l, t);
        rb.set(l + w, t + h);
        rect_color = rect_clr;
    ...
    IC
        ...
        void
        SetGrid(int w_div, float w_step, int h_div, float h_step, u32 grid_clr, u32 base_clr)
    {
    ...
    IC
        ...
        void
        SetMinMax(float _mn, float _mx, u32 item_count)
    {
        mn = _mn;
        mx = _mx;
    ...
    IC
        ...
        void
        AddMarker(EStyle Style, float pos, u32 Color)
    {
        SMarker NewMarker;
