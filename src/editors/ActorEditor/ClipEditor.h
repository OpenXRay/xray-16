...
class TClipMaker : public TForm, public pureFrame
{
    ...
    void __fastcall ClipDragOver(TObject* Sender, TObject* Source, int X, int Y, TDragState State, bool& Accept);
    void __fastcall ClipDragDrop(TObject* Sender, TObject* Source, int X, int Y);
    void __fastcall ClipMouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
    ...
    void __fastcall ClipMouseMove(TObject* Sender, TShiftState Shift, int X, int Y);
    void __fastcall ClipMouseUp(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
    void __fastcall FormShow(TObject* Sender);
    void __fastcall BPDragOver(TObject* Sender, TObject* Source, int X, int Y, TDragState State, bool& Accept);
    void __fastcall BPDragDrop(TObject* Sender, TObject* Source, int X, int Y);
    void __fastcall BPMouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
    void __fastcall BPMouseUp(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y);
    void __fastcall ebTrashClick(TObject* Sender);
    void __fastcall ebTrashDragOver(TObject* Sender, TObject* Source, int X, int Y, TDragState State, bool& Accept);
    void __fastcall ClipPaint(TObject* Sender);
    void __fastcall ebTrashDragDrop(TObject* Sender, TObject* Source, int X, int Y);
