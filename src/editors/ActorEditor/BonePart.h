...
class TfrmBonePart : public TForm
{
    ...
    void __fastcall tvPartDragDrop(TObject* Sender, TObject* Source, int X, int Y);
    void __fastcall tvPartDragOver(TObject* Sender, TObject* Source, int X, int Y, TDragState State, bool& Accept);
