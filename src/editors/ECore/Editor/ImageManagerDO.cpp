...
void blit(u32 *dest, u32 ds_x, u32 ds_y, u32 *src, u32 ss_x, u32 ss_y, u32 px, u32 py)
{
...
void blit_r(u32 *dest, u32 ds_x, u32 ds_y, u32 *src, u32 ss_x, u32 ss_y, u32 px, u32 py)
{
...
void _rect_register(U8Vec &mask, int dest_width, int dest_height, Irect &R)
{
    u32 s_x = R.width()+1;
    u32 s_y = R.height()+1;
...
bool _rect_test(U8Vec &mask, int dest_width, int dest_height, Irect &R)
{
    u32 s_x = R.width()+1;
    u32 s_y = R.height()+1;
...
bool _rect_place(U8Vec &mask, int dest_width, int dest_height, Irect &r, BOOL &bRotated)
{
    Irect R;
