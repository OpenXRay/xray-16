...
PDomain::PDomain(EType et, BOOL ra, u32 color, PDomainEnum t, float inA0, float inA1, float inA2, float inA3,
    float inA4, float inA5, float inA6, float inA7, float inA8)
{
...
void PDomain::Render(u32 clr, const Fmatrix& parent)
{
    ...
    case PDDisc:
        ...
        break;
    case PDRectangle: DU_impl.DrawRectangle(v[0], v[1], v[2], clr_s, clr_w, true, true); break;
    }
}
