...
#pragma region Windows Form Designer generated code
    ...
    void InitializeComponent(void)
    {
        ...
        System::ComponentModel::ComponentResourceManager ^ resources =
            (gcnew System::ComponentModel::ComponentResourceManager(window_weather_editor::typeid));
        ...
        this->WeatherTrackBar->MouseDown +=
            gcnew System::Windows::Forms::MouseEventHandler(this, &window_weather_editor::WeatherTrackBar_MouseDown);
        this->WeatherTrackBar->ValueChanged +=
            gcnew System::EventHandler(this, &window_weather_editor::WeatherTrackBar_ValueChanged);
        this->WeatherTrackBar->MouseUp +=
            gcnew System::Windows::Forms::MouseEventHandler(this, &window_weather_editor::WeatherTrackBar_MouseUp);
        //
        // panel25
        //
        ...
        this->CurrentTimeTextBox->TextChanged +=
            gcnew System::EventHandler(this, &window_weather_editor::CurrentTimeTextBox_TextChanged);
        //
        // label7
        //
        ...
        this->CurrentTimeTrackBar->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(
            this, &window_weather_editor::CurrentTimeTrackBar_MouseDown);
        this->CurrentTimeTrackBar->ValueChanged +=
            gcnew System::EventHandler(this, &window_weather_editor::CurrentTimeTrackBar_ValueChanged);
        this->CurrentTimeTrackBar->MouseUp +=
            gcnew System::Windows::Forms::MouseEventHandler(this, &window_weather_editor::CurrentTimeTrackBar_MouseUp);
        //
        // panel10
        //
        ...
        // NextFrameButton
        //
        this->NextFrameButton->Image =
            (cli::safe_cast<System::Drawing::Image ^>(resources->GetObject(L"NextFrameButton.Image")));
        ...
        this->PreviousFrameButton->Image =
            (cli::safe_cast<System::Drawing::Image ^>(resources->GetObject(L"PreviousFrameButton.Image")));
        ...
        this->PreviousFrameButton->Click +=
            gcnew System::EventHandler(this, &window_weather_editor::PreviousFrameButton_Click);
        //
        // panel3
        //
        ...
        this->WeathersComboBox->SelectedIndexChanged +=
            gcnew System::EventHandler(this, &window_weather_editor::WeathersComboBox_SelectedIndexChanged);
        //
        // panel7
        //
        ...
        this->TimeFactorNumericUpDown->ValueChanged +=
            gcnew System::EventHandler(this, &window_weather_editor::TimeFactorNumericUpDown_ValueChanged);
        //
        // panel5
        //
        ...
        this->FramesComboBox->SelectedIndexChanged +=
            gcnew System::EventHandler(this, &window_weather_editor::FramesComboBox_SelectedIndexChanged);
        this->FramesComboBox->DropDownClosed +=
            gcnew System::EventHandler(this, &window_weather_editor::FramesComboBox_DropDownClosed);
        this->FramesComboBox->DropDown +=
            gcnew System::EventHandler(this, &window_weather_editor::FramesComboBox_DropDown);
        //
        // panel2
        //
        ...
        this->CreateFromButton->Image =
            (cli::safe_cast<System::Drawing::Image ^>(resources->GetObject(L"CreateFromButton.Image")));
        ...
        this->CreateFromButton->Click +=
            gcnew System::EventHandler(this, &window_weather_editor::CreateFromButton_Click);
        //
        // splitter2
        //
        ...
        this->PasteTargetButton->Image =
            (cli::safe_cast<System::Drawing::Image ^>(resources->GetObject(L"PasteTargetButton.Image")));
        ...
        this->PasteTargetButton->Click +=
            gcnew System::EventHandler(this, &window_weather_editor::PasteTargetButton_Click);
        //
        // splitter1
        //
        ...
        this->PasteCurrentButton->Image =
            (cli::safe_cast<System::Drawing::Image ^>(resources->GetObject(L"PasteCurrentButton.Image")));
        ...
        this->PasteCurrentButton->Click +=
            gcnew System::EventHandler(this, &window_weather_editor::PasteCurrentButton_Click);
        //
        // ReloadCurrentButton
        //
        this->ReloadCurrentButton->AutoSize = true;
        this->ReloadCurrentButton->Image =
            (cli::safe_cast<System::Drawing::Image ^>(resources->GetObject(L"ReloadCurrentButton.Image")));
        ...
        this->ReloadCurrentButton->Click +=
            gcnew System::EventHandler(this, &window_weather_editor::ReloadCurrentButton_Click);
        //
        // ReloadTargetButton
        //
        this->ReloadTargetButton->AutoSize = true;
        this->ReloadTargetButton->Image =
            (cli::safe_cast<System::Drawing::Image ^>(resources->GetObject(L"ReloadTargetButton.Image")));
        ...
        this->ReloadTargetButton->Click +=
            gcnew System::EventHandler(this, &window_weather_editor::ReloadTargetButton_Click);
        //
        // window_weather_editor
        //
        ...
        this->SizeChanged +=
            gcnew System::EventHandler(this, &window_weather_editor::window_weather_editor_SizeChanged);
