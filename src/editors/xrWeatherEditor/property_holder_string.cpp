...
XRay::Editor::property_value* property_holder::add_property(const char* identifier, const char* category, const char* description,
    const char* default_value, string_getter_type const& getter, string_setter_type const& setter,
...
XRay::Editor::property_value* property_holder::add_property(const char* identifier, const char* category, const char* description,
    const char* default_value, shared_str& value, readonly_enum const& read_only,
...
XRay::Editor::property_value* property_holder::add_property(const char* identifier, const char* category, const char* description,
    const char* default_value, string_getter_type const& getter, string_setter_type const& setter, const char* default_extension,
    const char* file_mask, const char* default_folder, const char* caption, enter_text_enum const& can_enter_text,
...
XRay::Editor::property_value* property_holder::add_property(const char* identifier, const char* category, const char* description,
    const char* default_value, shared_str& value, const char* default_extension, const char* file_mask, const char* default_folder,
    const char* caption, enter_text_enum const& can_enter_text, extension_action_enum const& extension_action,
    readonly_enum const& read_only, notify_parent_on_change_enum const& notify_parent,
    password_char_enum const& password, refresh_grid_on_change_enum const& refresh_grid)
{
    m_container->add_property((can_enter_text == property_holder::can_enter_text) ?
...
XRay::Editor::property_value* property_holder::add_property(const char* identifier, const char* category, const char* description,
    const char* default_value, string_getter_type const& getter, string_setter_type const& setter, const char* const* values,
...
XRay::Editor::property_value* property_holder::add_property(const char* identifier, const char* category, const char* description,
    const char* default_value, shared_str& value, const char* const* values, u32 const& value_count,
...
XRay::Editor::property_value* property_holder::add_property(const char* identifier, const char* category, const char* description,
    const char* default_value, shared_str& value, string_collection_getter_type const& values,
