...
XRay::Editor::property_value* property_holder::add_property(const char* identifier, const char* category, const char* description,
    int const& default_value, integer_getter_type const& getter, integer_setter_type const& setter,
    std::pair<int, const char*>* values, u32 const& value_count, readonly_enum const& read_only,
    notify_parent_on_change_enum const& notify_parent, password_char_enum const& password,
    refresh_grid_on_change_enum const& refresh_grid)
{
...
XRay::Editor::property_value* property_holder::add_property(const char* identifier, const char* category, const char* description,
    int const& default_value, int& value, std::pair<int, const char*>* values, u32 const& value_count,
    readonly_enum const& read_only, notify_parent_on_change_enum const& notify_parent,
    password_char_enum const& password, refresh_grid_on_change_enum const& refresh_grid)
{
    m_container->add_property(
...
XRay::Editor::property_value* property_holder::add_property(const char* identifier, const char* category, const char* description,
    int const& default_value, integer_getter_type const& getter, integer_setter_type const& setter,
    const char* const* values, u32 const& value_count, readonly_enum const& read_only,
    notify_parent_on_change_enum const& notify_parent, password_char_enum const& password,
    refresh_grid_on_change_enum const& refresh_grid)
{
    m_container->add_property(
...
XRay::Editor::property_value* property_holder::add_property(const char* identifier, const char* category, const char* description,
    int const& default_value, int& value, const char* const* values, u32 const& value_count, readonly_enum const& read_only,
    notify_parent_on_change_enum const& notify_parent, password_char_enum const& password,
    refresh_grid_on_change_enum const& refresh_grid)
{
    m_container->add_property(
