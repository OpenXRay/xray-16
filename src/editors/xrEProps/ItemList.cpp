...
void __fastcall TItemList::tvItemsMouseDown(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y)
{
...
void __fastcall TItemList::tvItemsMouseMove(TObject* Sender, TShiftState Shift, int X, int Y)
{
    //
}
//---------------------------------------------------------------------------

void __fastcall TItemList::tvItemsMouseUp(TObject* Sender, TMouseButton Button, TShiftState Shift, int X, int Y)
{
    //
}
//---------------------------------------------------------------------------
...
void __fastcall TItemList::tvItemsItemDraw(
...
void __fastcall TItemList::InplaceEditValidateResult(TObject* Sender, bool& InputValid)
{
...
void __fastcall TItemList::tvItemsDragDrop(TObject* Sender, TObject* Source, int X, int Y)
{
    R_ASSERT(m_Flags.is(ilEditMenu));
...
void __fastcall TItemList::tvItemsCompareItems(TObject* Sender, TElTreeItem* Item1, TElTreeItem* Item2, int& res)
{
