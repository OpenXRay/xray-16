...
class XR_EPROPS_API TItemList : public TForm
{
    ...
    void __fastcall tvItemsItemDraw(TObject* Sender, TElTreeItem* Item, TCanvas* Surface, TRect& R, int SectionIndex);
    ...
    void __fastcall tvItemsDragDrop(TObject* Sender, TObject* Source, int X, int Y);
    void __fastcall Delete1Click(TObject* Sender);
    void __fastcall InplaceEditAfterOperation(TObject* Sender, bool& Accepted, bool& DefaultConversion);
...
public: // User declarations
    ...
    virtual void GenerateObjectName(
        shared_str& name, LPCSTR start_node, LPCSTR pref = "object", bool num_first = false);
