...
bool NumericVectorRun(
    const char* title, Fvector* data, int decimal, Fvector* reset_value, Fvector* min, Fvector* max, int* X, int* Y)
{
    frmNumericVector = new TfrmNumericVector((TComponent*)0);
...
//----------------------------------------------------
bool __fastcall TfrmNumericVector::Run(
    const char* title, Fvector* data, int decimal, Fvector* rv, Fvector* MN, Fvector* MX, int* X, int* Y)
{
