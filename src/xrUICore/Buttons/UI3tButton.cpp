...
void CUI3tButton::InitSoundH(const char* sound_file) { GEnv.Sound->create(m_sound_h, sound_file, st_Effect, sg_SourceType); }
void CUI3tButton::InitSoundT(const char* sound_file) { GEnv.Sound->create(m_sound_t, sound_file, st_Effect, sg_SourceType); }
