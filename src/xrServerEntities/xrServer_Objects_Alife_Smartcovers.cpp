...
const char* CSE_SmartCover::description() const { return (m_description.c_str()); }
#ifndef AI_COMPILER
...
float parse_float(luabind::object const& table, const char* identifier, float const& min_threshold = flt_min,
