...
#ifndef NO_XR_GAME
    if (pSettingsOpenXRay->read_if_exists<bool>("gameplay", "register_actor_mp", gameMode.is(shadowOfChernobylMode)))
...
#ifndef NO_XR_GAME
    if (pSettingsOpenXRay->read_if_exists<bool>("gameplay", "register_level_changer", gameMode.is(shadowOfChernobylMode)))
    {
