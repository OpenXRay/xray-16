...
SCRIPT_EXPORT(Flags8, (), {
    module(luaState)[class_<Flags8>(
        "flags8").def(constructor<>())
                         .def("get", &Flags8::get)
...
SCRIPT_EXPORT(Flags16, (), {
    module(luaState)[class_<Flags16>(
        "flags16").def(constructor<>())
                         .def("get", &Flags16::get)
...
SCRIPT_EXPORT(Flags32, (), {
    module(luaState)[class_<Flags32>(
        "flags32").def(constructor<>())
                         .def("get", &Flags32::get)
