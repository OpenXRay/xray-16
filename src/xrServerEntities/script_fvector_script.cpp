...
SCRIPT_EXPORT(
    Fvector, (), {
        module(
            luaState)[class_<Fvector>(
            "vector").def_readwrite("x", &Fvector::x)
                          ...
                          .def("mad", (Fvector & (Fvector::*)(const Fvector&, const Fvector&))(&Fvector::mad),
                              return_reference_to<1>())
                          .def("mad",
                              (Fvector & (Fvector::*)(const Fvector&, const Fvector&, const Fvector&))(&Fvector::mad),
                              return_reference_to<1>())
                          ...
                          //			.def("from_bary",					(Fvector & (Fvector::*)(const Fvector &,
                          //const Fvector &, const Fvector &, float, float, float))(&Fvector::from_bary),
                          //return_reference_to<1>())
                          //			.def("from_bary",					(Fvector & (Fvector::*)(const Fvector &,
                          //const Fvector &, const Fvector &, const Fvector &))(&Fvector::from_bary),
                          //return_reference_to<1>())
