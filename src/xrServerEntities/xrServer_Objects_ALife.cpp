...
struct logical_string_predicate
{
    ...
    bool operator()(const char* const& first, const char* const& second) const
    {
        ...
        const wchar_t * buffer0 = (const wchar_t *)xr_alloca(buffer_size0);
        AnsiToUnicode(first, (LPVOID)buffer0, buffer_size0);

        u32 buffer_size1 = (xr_strlen(second) + 1) * 2;
        const wchar_t * buffer1 = (const wchar_t *)xr_alloca(buffer_size1);
...
#ifndef XRGAME_EXPORTS
void CSE_ALifeDynamicObject::FillProps(const char* pref, PropItemVec& values) { inherited::FillProps(pref, values); }
#endif // #ifndef XRGAME_EXPORTS

////////////////////////////////////////////////////////////////////////////
// CSE_ALifeDynamicObjectVisual
////////////////////////////////////////////////////////////////////////////
CSE_ALifeDynamicObjectVisual::CSE_ALifeDynamicObjectVisual(const char* caSection)
...
////////////////////////////////////////////////////////////////////////////
CSE_ALifePHSkeletonObject::CSE_ALifePHSkeletonObject(const char* caSection)
...
////////////////////////////////////////////////////////////////////////////
CSE_ALifeObjectPhysic::CSE_ALifeObjectPhysic(const char* caSection)
    : CSE_ALifeDynamicObjectVisual(caSection), CSE_PHSkeleton(caSection)
{
    type = epotSkeleton;
    mass = 10.f;
...
////////////////////////////////////////////////////////////////////////////
CSE_ALifeObjectHangingLamp::CSE_ALifeObjectHangingLamp(const char* caSection)
    : CSE_ALifeDynamicObjectVisual(caSection), CSE_PHSkeleton(caSection)
{
...
#ifndef XRGAME_EXPORTS
void CSE_ALifeObjectProjector::FillProps(const char* pref, PropItemVec& values) { inherited::FillProps(pref, values); }
#endif // #ifndef XRGAME_EXPORTS
...
CSE_ALifeHelicopter::CSE_ALifeHelicopter(const char* caSection)
...
#ifndef XRGAME_EXPORTS
void CSE_ALifeMountedWeapon::FillProps(const char* pref, PropItemVec& values) { inherited::FillProps(pref, values); }
#endif // #ifndef XRGAME_EXPORTS
...
#ifndef XRGAME_EXPORTS
void CSE_ALifeStationaryMgun::FillProps(const char* pref, PropItemVec& values) { inherited::FillProps(pref, values); }
#endif // #ifndef XRGAME_EXPORTS

////////////////////////////////////////////////////////////////////////////
// CSE_ALifeTeamBaseZone
////////////////////////////////////////////////////////////////////////////
CSE_ALifeTeamBaseZone::CSE_ALifeTeamBaseZone(const char* caSection) : CSE_ALifeSpaceRestrictor(caSection) { m_team = 0; }
...
CSE_ALifeSmartZone::CSE_ALifeSmartZone(const char* caSection)
...
#ifndef XRGAME_EXPORTS
void CSE_ALifeSmartZone::FillProps(const char* pref, PropItemVec& items) { inherited1::FillProps(pref, items); }
#endif // #ifndef XRGAME_EXPORTS
...
#ifndef XRGAME_EXPORTS
void CSE_ALifeInventoryBox::FillProps(const char* pref, PropItemVec& values) { inherited::FillProps(pref, values); }
#endif // #ifndef XRGAME_EXPORTS
