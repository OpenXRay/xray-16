...
SCRIPT_EXPORT(Fmatrix, (), {
    module(luaState)[class_<Fmatrix>(
        "matrix").def_readwrite("i", &Fmatrix::i)
                         ...
                         .def("set", (Fmatrix & (Fmatrix::*)(const Fvector&, const Fvector&, const Fvector&,
                         ...
                         // return_reference_to<1>())
                         //			.def("rotation",					(Fmatrix & (Fmatrix::*)(const Fvector &, const
                         // Fvector &))(&Fmatrix::rotation), return_reference_to<1>())
                         ...
                         */
                         ...
                         // Fvector &) const)(&Fmatrix::transform_tiny), out_value<2>())
                         //			.def("transform_dir",				(void	   (Fmatrix::*)(Fvector &)
                         // const)(&Fmatrix::transform_dir), out_value<2>())
                         //			.def("transform_dir",				(void	   (Fmatrix::*)(Fvector &, const
                         // Fvector &) const)(&Fmatrix::transform_dir), out_value<2>())
                         ...
                         //			.def("setXYZ",						(Fmatrix & (Fmatrix::*)(Fvector
                         //&))(&Fmatrix::setXYZ), policy_list<return_reference_to<1>, out_value<2>>())
