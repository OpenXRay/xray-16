...
CAI_Dog::CAI_Dog()
{
    ...
    if (pSettingsOpenXRay->read_if_exists<bool>("gameplay", "control_jump", !gameMode.is(shadowOfChernobylMode)))
...
void CAI_Dog::reinit()
{
    ...
    if (pSettingsOpenXRay->read_if_exists<bool>("gameplay", "add_melee_jump_data", gameMode.is(shadowOfChernobylMode)))
...
void CAI_Dog::reload(LPCSTR section)
{
    ...
    if (pSettingsOpenXRay->read_if_exists<bool>("gameplay", "load_jump_data", gameMode.is(shadowOfChernobylMode)))
    {
