...
CAI_Dog::CAI_Dog()
{
    ...
    if (pSettingsOpenXRay->read_if_exists<bool>("gameplay", "control_jump", !psGameMode.is(ShadowOfChernobylMode)))
...
void CAI_Dog::reinit()
{
    ...
    if (pSettingsOpenXRay->read_if_exists<bool>("gameplay", "add_melee_jump_data", psGameMode.is(ShadowOfChernobylMode)))
...
void CAI_Dog::reload(LPCSTR section)
{
    ...
    if (pSettingsOpenXRay->read_if_exists<bool>("gameplay", "load_jump_data", psGameMode.is(ShadowOfChernobylMode)))
    {
