...
template <class T>
void CDialogScriptHelper::LoadSequence(CUIXml* uiXml, XML_NODE phrase_node, const char* tag, T& str_vector)
{
...
const char* CDialogScriptHelper::GetScriptText(const char* str_to_translate, const CGameObject* pSpeakerGO1,
    const CGameObject* pSpeakerGO2, const char* dialog_id, const char* phrase_id)
{
    ...
    const char* res = lua_function(pSpeakerGO1->lua_game_object(), pSpeakerGO2->lua_game_object(), dialog_id, phrase_id);
...
bool CDialogScriptHelper::Precondition(const CGameObject* pSpeakerGO1, const CGameObject* pSpeakerGO2, const char* dialog_id,
    const char* phrase_id, const char* next_phrase_id) const
{
    bool predicate_result = true;
...
void CDialogScriptHelper::Action(
    const CGameObject* pSpeakerGO1, const CGameObject* pSpeakerGO2, const char* dialog_id, const char* phrase_id) const
{
