...
IC const char* Property::id_str() const { return m_id.c_str(); }
IC const char* Property::icon_name() const { return m_icon.c_str(); }
IC const char* Property::name() const { return m_name.c_str(); }
