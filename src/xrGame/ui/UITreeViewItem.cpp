...
{
    // The original SoC CUIListItem constructor left-aligned list text.
    // The shared modern list item now uses the centered button default.
                      ...
                      bool markRead)
{
    ...
    pTVItem->SetText(CStringTable().translate(leafName.c_str()).c_str());
