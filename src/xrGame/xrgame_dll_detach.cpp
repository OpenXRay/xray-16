...
void init_game_globals()
{
    ...
    {
        CInfoPortion::InitInternal(gameMode.is_any(clearSkyMode | shadowOfChernobylMode), true);
        CEncyclopediaArticle::InitInternal(gameMode.is(shadowOfChernobylMode), true);
