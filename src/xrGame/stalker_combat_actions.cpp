...
CStalkerActionGetReadyToKill::CStalkerActionGetReadyToKill(
    bool affect_properties, CAI_Stalker* object, const char* action_name)
    : inherited(object, action_name)
{
...
CStalkerActionLookOut::CStalkerActionLookOut(CAI_Stalker* object, const char* action_name) : inherited(object, action_name)
{
