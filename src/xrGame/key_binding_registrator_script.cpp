    ...
    [
        ...
        class_<KeyBindingRegistrator>("DIK_keys")
            ...
            [
                ...
                value("GCB_A", int(XR_CONTROLLER_BUTTON_A)),
                value("GCB_B", int(XR_CONTROLLER_BUTTON_B)),
                value("GCB_X", int(XR_CONTROLLER_BUTTON_X)),
                value("GCB_Y", int(XR_CONTROLLER_BUTTON_Y)),
                value("GCB_BACK", int(XR_CONTROLLER_BUTTON_BACK)),
                value("GCB_GUIDE", int(XR_CONTROLLER_BUTTON_GUIDE)),
                value("GCB_START", int(XR_CONTROLLER_BUTTON_START)),
                value("GCB_LEFTSTICK", int(XR_CONTROLLER_BUTTON_LEFTSTICK)),
                value("GCB_RIGHTSTICK", int(XR_CONTROLLER_BUTTON_RIGHTSTICK)),
                value("GCB_LEFTSHOULDER", int(XR_CONTROLLER_BUTTON_LEFTSHOULDER)),
                value("GCB_RIGHTSHOULDER", int(XR_CONTROLLER_BUTTON_RIGHTSHOULDER)),
                value("GCB_DPAD_UP", int(XR_CONTROLLER_BUTTON_DPAD_UP)),
                value("GCB_DPAD_DOWN", int(XR_CONTROLLER_BUTTON_DPAD_DOWN)),
