...
{
public:
    CCC_CreateGameSpyAccount(const char* N) : IConsole_Command(N) { bEmptyArgsHandled = false; };
...
{
public:
    CCC_GapySpyListProfiles(const char* N) : IConsole_Command(N) { bEmptyArgsHandled = false; };
    virtual void Execute(const char* args);
...
{
public:
    CCC_GameSpyLogin(const char* N) : IConsole_Command(N) { bEmptyArgsHandled = false; };
    virtual void Execute(const char* args);
...
{
public:
    CCC_GameSpyLogout(const char* N) : IConsole_Command(N) { bEmptyArgsHandled = true; };
    virtual void Execute(const char* args);
...
{
public:
    CCC_GameSpyPrintProfile(const char* N) : IConsole_Command(N) { bEmptyArgsHandled = true; };
    virtual void Execute(const char* args);
...
{
public:
    CCC_GameSpySuggestUNicks(const char* N) : IConsole_Command(N) { bEmptyArgsHandled = false; };
    virtual void Execute(const char* args);
...
{
public:
    CCC_GameSpyRegisterUniqueNick(const char* N) : IConsole_Command(N) { bEmptyArgsHandled = false; };
    virtual void Execute(const char* args);
...
{
public:
    CCC_GameSpyDeleteProfile(const char* N) : IConsole_Command(N) { bEmptyArgsHandled = true; };
    virtual void Execute(const char* args);
...
{
public:
    CCC_GameSpyProfile(const char* N) : IConsole_Command(N) { bEmptyArgsHandled = false; };
    virtual void Execute(const char* args);
