...
const char* state_names[] = {"cr_", "norm_", "dmg_norm_", 0};

const char* weapon_names[] = {"0_", "1_", "2_", "3_", "4_", "5_", "6_", "7_", "8_", "9_", "10_", 0};

const char* weapon_action_names[] = {"draw_", // 0
    "attack_", // 1
    "drop_", // 2
    "holster_", // 3
    "reload_", // 4
...
const char* movement_names[] = {"walk_", "run_", 0};

const char* movement_action_names[] = {"fwd_", "back_", "ls_", "rs_", 0};

const char* in_place_names[] = {"idle_0", "idle_1", "turn_right_0", "turn_left_0", "turn_right_1", "turn_left_1",
    "jump_begin", "jump_idle", "jump_end", "jump_end_1", 0};

const char* global_names[] = {"damage_", // 0
    "escape_", // 1
    "dead_stop_", // 2
    "hello_", // 3
...
const char* head_names[] = {"head_idle_0", "head_talk_0", 0};
