...
public:
    Activity() = default;
    Activity(Activity const& rhs) = default;
    Activity& operator=(Activity const& rhs) = default;
    Activity(Activity&& rhs) = default;
    Activity& operator=(Activity&& rhs) = default;

    Activity(const DiscordActivity& activity) : internal_(activity) {}
